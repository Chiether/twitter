...
module Twitter
  module REST
    module Collections
      ...
      # Returns all timelines the user's collection
      #
      # @see https://developer.twitter.com/en/docs/tweets/curate-a-collection/api-reference/get-collections-list
      # @rate_limited Yes
      ...
      def collections(options = {})
        result = perform_get('/1.1/collections/list.json', options)
        objects = result[:objects]
        response = result[:response]
        Twitter::Collection.new(objects, response)
      end
